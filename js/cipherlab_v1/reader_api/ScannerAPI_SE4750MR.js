...
QUnit.test("BarCodeGetReaderType", function(assert) {
  ...
  assert.ok(name=="SE4750MR", "Return value passed["+name+"]");
});
...
function test_BarCodeGetDecodersStatus_Valid(){
  ...
  test_BarCodeSetDecodersStatus_valid_value("enableCode11", [0,1]);
  ...
  test_BarCodeSetDecodersStatus_valid_value("enableChinese2Of5", [0,1]);
  ...
  test_BarCodeSetDecodersStatus_valid_value("enableMicroQR", [0,1]);
  ...
  test_BarCodeSetDecodersStatus_valid_value("enableUKPostal", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableUPUFICSPostal", [0,1]);
  ...
  test_BarCodeSetDecodersStatus_valid_value("enableUSPSPostal",[0,1]);
}
...
QUnit.test("GS1DataBarLimited", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("convertToUpcEan", true, 1, ret_GS1DataBarLimited);
...
function test_BarCodeGetUserPreferences_Invalid(){
  ...
  test_BarCodeSetUserPreferences_valid_value("negativeBarcodes", [1,2,0]);
  test_BarCodeSetUserPreferences_valid_value("pickListMode", [1,0]);
  test_BarCodeSetUserPreferences_valid_value("redundancyLevel", [2,3,4,1]);
  test_BarCodeSetUserPreferences_valid_value("scanAngle", -1);
  test_BarCodeSetUserPreferences_valid_value("securityLevel", [1,2,3,0]);
  ...
  test_BarCodeSetUserPreferences_valid_value("interCharGapSize", [10,6]);
...
function test_BarCodeGetUserPreferences_Invalid(){
  ...
  test_BarCodeSetUserPreferences_invalid_value("negativeBarcodes", [-2,3]);
  ...
  test_BarCodeSetUserPreferences_invalid_value("scanAngle", [-2,0,1,2]);
  test_BarCodeSetUserPreferences_invalid_value("securityLevel", [-2,4]);
  test_BarCodeSetUserPreferences_invalid_value("timeoutBetweenSameSymbology", [-2,9901]);
  test_BarCodeSetUserPreferences_invalid_value("transmitCodeIdChar", [-2,2]);
  test_BarCodeSetUserPreferences_invalid_value("triggerMode", [-2,1,4]);
  ...
  test_BarCodeSetUserPreferences_invalid_value("decodingIlluminationPowerLevel", [-2,11]);
