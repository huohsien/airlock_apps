...
QUnit.test("BarCodeGetReaderType", function(assert) {
  ...
  assert.ok(name=="EX25", "Return value passed["+name+"]");
});
...
function test_BarCodeSetDecodersStatus_Valid(){
  test_BarCodeSetDecodersStatus_valid_value("enableAustralianPostal", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableAztec", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableCompositeCC_AB", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableCompositeCC_C", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableCompositeTlc39", -1);
  test_BarCodeSetDecodersStatus_valid_value("enableCode11", [1,0]);
  ...
  test_BarCodeSetDecodersStatus_valid_value("enableCodabar", [1,0]);
  test_BarCodeSetDecodersStatus_valid_value("enableChinese2Of5", -1);
  test_BarCodeSetDecodersStatus_valid_value("enableDataMatrix", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableDutchPostal", [0,1]);
  ...
  test_BarCodeSetDecodersStatus_valid_value("enableJapanPostal", [0,1]);
  ...
  test_BarCodeSetDecodersStatus_valid_value("enableMaxiCode", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableMicroPDF417", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableMicroQR", -1);
  test_BarCodeSetDecodersStatus_valid_value("enableMsi", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enablePDF417", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enablePlessey", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableQRcode", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableTelepen", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableTriopticCode39", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableUpcA", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableUpcE", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableUpcE1", [0,1]);
  ...
  test_BarCodeSetDecodersStatus_valid_value("enableUSPostnet", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableUSPlanet", [0,1]);
  test_BarCodeSetDecodersStatus_valid_value("enableUSPSPostal", -1);
}

function test_BarCodeSetDecodersStatus_Invalid(){
  test_BarCodeSetDecodersStatus_invalid_value("enableAustralianPostal", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableAztec", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableCompositeCC_AB", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableCompositeCC_C", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableCompositeTlc39", [-2,0,2]);
  test_BarCodeSetDecodersStatus_invalid_value("enableCode11", [-1,2])
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableDataMatrix", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableDutchPostal", [-1,2])
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableJapanPostal", [-1,2])
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableMaxiCode", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableMicroPDF417", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableMicroQR", [-2,0,2]);
  test_BarCodeSetDecodersStatus_invalid_value("enableMsi", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enablePDF417", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enablePlessey", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableQRcode", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableTelepen", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableTriopticCode39", [-1,2])
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableUSPostnet", [-1,2])
  test_BarCodeSetDecodersStatus_invalid_value("enableUSPlanet", [-1,2])
...
QUnit.test("BarCodeGetDecodersStatus", function(assert) {
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableAustralianPostal", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableAztec", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableCompositeCC_AB", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableCompositeCC_C", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableCompositeTlc39", false, -1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableCode11", true, 0, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableCodabar", true, 0, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableChinese2Of5", false, -1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableDataMatrix", true,  1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableDutchPostal", true, 1, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableJapanPostal", true, 1, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableMaxiCode", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableMicroPDF417", true, 1, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enablePDF417", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enablePlessey", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableQRcode", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableTelepen", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableTriopticCode39", true, 1, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableUpcE1", true, 1, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableUSPostnet", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableUSPlanet", true, 1, ret_BarCodeGetDecodersStatus);
...
function test_Codabar_Valid(){
  test_BarCodeSetSymbology_valid_value("Codabar", "transmitCheckDigit", [0,1]);
  ...
  test_BarCodeSetSymbology_valid_value("Codabar", "length1", [55,0,6]);
  test_BarCodeSetSymbology_valid_value("Codabar", "length2", [55,0]);
...
QUnit.test("Codabar", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Codabar);
  test_BarCodeGetSymbology_initial_value("length1", true, 6, ret_Codabar);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Codabar);
...
function test_Code11_Valid(){
  test_BarCodeSetSymbology_valid_value("Code11", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("Code11", "length1", [55,0,6]);
  test_BarCodeSetSymbology_valid_value("Code11", "length2", [55,0]);
  test_BarCodeSetSymbology_valid_value("Code11", "numberOfCheckDigits", [2,1]);
  test_BarCodeSetSymbology_valid_value("Code11", "transmitCheckDigit", [0,1]);
}

function test_Code11_Invalid(){
  test_BarCodeSetSymbology_invalid_value("Code11", "enable", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("Code11", "length1", [-2,56]);
  test_BarCodeSetSymbology_invalid_value("Code11", "length2", [-2,56]);
  test_BarCodeSetSymbology_invalid_value("Code11", "numberOfCheckDigits", [-2,0,3]);
...
QUnit.test("Code11", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Code11);
  test_BarCodeGetSymbology_initial_value("length1", true, 0, ret_Code11);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Code11);
  test_BarCodeGetSymbology_initial_value("numberOfCheckDigits", true, 1, ret_Code11);
  test_BarCodeGetSymbology_initial_value("transmitCheckDigit", true, 1, ret_Code11);
...
function test_Code39_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("Code39", "length1", [55,0,6]);
  test_BarCodeSetSymbology_valid_value("Code39", "length2", [55,0]);
  ...
  test_BarCodeSetSymbology_valid_value("Code39", "convertToCode32", -1);
  test_BarCodeSetSymbology_valid_value("Code39", "convertToCode32Prefix", -1);
} 
...
function test_Code39_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("Code39", "convertToCode32", [-2,0,2]);
  test_BarCodeSetSymbology_invalid_value("Code39", "convertToCode32Prefix", [-2,0,2]);
} 
...
QUnit.test("Code39", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("length1", true, 0, ret_Code39);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Code39);
  ...
  test_BarCodeGetSymbology_initial_value("convertToCode32", false, -1, ret_Code39);
  test_BarCodeGetSymbology_initial_value("convertToCode32Prefix", false, -1, ret_Code39);
...
function test_Code93_Valid(){
  test_BarCodeSetSymbology_valid_value("Code93", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("Code93", "length1", [55,0,1]);
  test_BarCodeSetSymbology_valid_value("Code93", "length2", [55,0]);
}
...
QUnit.test("Code93", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Code93);
  test_BarCodeGetSymbology_initial_value("length1", true, 1, ret_Code93);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Code93);
...
function test_Code128_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("Code128", "securitylevel", -1);
}

function test_Code128_Invalid(){
  test_BarCodeSetSymbology_invalid_value("Code128", "enable", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("Code128", "securitylevel", [-2,0,2]);
}
...
QUnit.test("Code128", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("securitylevel", false, -1, ret_Code128);
...
function test_ISBT128_Valid(){
  test_BarCodeSetSymbology_valid_value("ISBT128", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("ISBT128", "concatenation", [1,2,0]);
...
function test_ISBT128_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("ISBT128", "concatenation", [-2,3]);
  test_BarCodeSetSymbology_invalid_value("ISBT128", "concatenationRedundancy", [1,21]);
}

QUnit.test("ISBT128", function(assert) {
  var ret_ISBT128 = test_BarCodeGetSymbology_return_object("ISBT128", true);

  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_ISBT128);
  test_BarCodeGetSymbology_initial_value("concatenation", true, 0, ret_ISBT128);
...
QUnit.test("Chinese2Of5", function(assert) {
  var ret_Chinese2Of5 = test_BarCodeGetSymbology_return_object("Chinese2Of5", false);
...
function test_Industrial2Of5_Valid(){
  test_BarCodeSetSymbology_valid_value("Industrial2Of5", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("Industrial2Of5", "length1", [55,0,6]);
  test_BarCodeSetSymbology_valid_value("Industrial2Of5", "length2", [55,0]);
}
...
QUnit.test("Industrial2Of5", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Industrial2Of5);
  test_BarCodeGetSymbology_initial_value("length1", true, 6, ret_Industrial2Of5);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Industrial2Of5);
...
function test_Interleaved2Of5_Valid(){
  test_BarCodeSetSymbology_valid_value("Interleaved2Of5", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("Interleaved2Of5", "length1", [55,0,6]);
  test_BarCodeSetSymbology_valid_value("Interleaved2Of5", "length2", [55,0]);
  test_BarCodeSetSymbology_valid_value("Interleaved2Of5", "checkDigitVerification", [3,4,0]);
...
function test_Interleaved2Of5_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("Interleaved2Of5", "checkDigitVerification", [-2,5]);
...
QUnit.test("Interleaved2Of5", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Interleaved2Of5);
  test_BarCodeGetSymbology_initial_value("length1", true, 6, ret_Interleaved2Of5);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Interleaved2Of5);
...
function test_Matrix2Of5_Valid(){
  test_BarCodeSetSymbology_valid_value("Matrix2Of5", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("Matrix2Of5", "length1", [55,0,6]);
  test_BarCodeSetSymbology_valid_value("Matrix2Of5", "length2", [55,0]);
  test_BarCodeSetSymbology_valid_value("Matrix2Of5", "redundancy", -1);
  test_BarCodeSetSymbology_valid_value("Matrix2Of5", "checkDigitVerification", -1);
  test_BarCodeSetSymbology_valid_value("Matrix2Of5", "transmitCheckDigit", -1);
} 
...
function test_Matrix2Of5_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("Matrix2Of5", "redundancy", [-2,0,2]);
  test_BarCodeSetSymbology_invalid_value("Matrix2Of5", "checkDigitVerification", [-2,0,2]);
  test_BarCodeSetSymbology_invalid_value("Matrix2Of5", "transmitCheckDigit", [-2,0,2]);
} 

QUnit.test("Matrix2Of5", function(assert) {
  var ret_Matrix2Of5 = test_BarCodeGetSymbology_return_object("Matrix2Of5", true);

  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Matrix2Of5);
  test_BarCodeGetSymbology_initial_value("length1", true, 6, ret_Matrix2Of5);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Matrix2Of5);
  test_BarCodeGetSymbology_initial_value("redundancy", false, -1, ret_Matrix2Of5);
  test_BarCodeGetSymbology_initial_value("checkDigitVerification", false, -1, ret_Matrix2Of5);
  test_BarCodeGetSymbology_initial_value("transmitCheckDigit", false, -1, ret_Matrix2Of5);
...
function test_Composite_Valid(){
  test_BarCodeSetSymbology_valid_value("Composite", "enableCc_C", [1,0]);
  test_BarCodeSetSymbology_valid_value("Composite", "enableCc_AB", [1,0]);
...
function test_Composite_Invalid(){
  test_BarCodeSetSymbology_invalid_value("Composite", "enableCc_C", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("Composite", "enableCc_AB", [-1,2]);
...
QUnit.test("Composite", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enableCc_C", true, 0, ret_Composite);
  test_BarCodeGetSymbology_initial_value("enableCc_AB", true, 0, ret_Composite);
...
function test_UccCoupon_Valid(){
  test_BarCodeSetSymbology_valid_value("UccCoupon", "enable", [0,1]);
}

function test_UccCoupon_Invalid(){
  test_BarCodeSetSymbology_invalid_value("UccCoupon", "enable", [-1,2]);
}

QUnit.test("UccCoupon", function(assert) {
  var ret_UccCoupon = test_BarCodeGetSymbology_return_object("UccCoupon", false);
  //test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_UccCoupon);
...
function test_GS1DataBar14_Valid(){
  test_BarCodeSetSymbology_valid_value("GS1DataBar14", "enable", [1,0]);
...
QUnit.test("GS1DataBar14", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_GS1DataBar14);
...
function test_GS1DataBarLimited_Valid(){
  test_BarCodeSetSymbology_valid_value("GS1DataBarLimited", "enable", [1,0]);
...
QUnit.test("GS1DataBarLimited", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_GS1DataBarLimited);
...
function test_GS1DataBarExpanded_Valid(){
  test_BarCodeSetSymbology_valid_value("GS1DataBarExpanded", "enable", [1,0]);
...
QUnit.test("GS1DataBarExpanded", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_GS1DataBarExpanded);
...
function test_Korean3Of5_Valid(){
  test_BarCodeSetSymbology_valid_value("Korean3Of5", "enable", [0,1]);
} 

function test_Korean3Of5_Invalid(){
  test_BarCodeSetSymbology_invalid_value("Korean3Of5", "enable",  [-1,2]);
} 

QUnit.test("Korean3Of5", function(assert) {
  var ret_Korean3Of5 = test_BarCodeGetSymbology_return_object("Korean3Of5", false);
  //test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Korean3Of5);
...
function test_Msi_Valid(){
  test_BarCodeSetSymbology_valid_value("Msi", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("Msi", "length1", [0,55,6]);
  ...
  test_BarCodeSetSymbology_valid_value("Msi", "checkDigitAlgorithm", -1);
} 
...
function test_Msi_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("Msi", "checkDigitAlgorithm", [-2,1,2]);
}

QUnit.test("Msi", function(assert) {
  var ret_Msi = test_BarCodeGetSymbology_return_object("Msi", true);

  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Msi);
  test_BarCodeGetSymbology_initial_value("length1", true, 6, ret_Msi);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Msi);
  ...
  test_BarCodeGetSymbology_initial_value("checkDigitAlgorithm", false, -1, ret_Msi);
...
function test_USPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("USPostal", "enablePlanet", [1,0]);
  test_BarCodeSetSymbology_valid_value("USPostal", "enablePostnet", [1,0]);
  test_BarCodeSetSymbology_valid_value("USPostal", "transmitCheckDigit", [0,1]);
} 

function test_USPostal_Invalid(){
  test_BarCodeSetSymbology_invalid_value("USPostal", "enablePlanet", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("USPostal", "enablePostnet", [-1,2]);
...
QUnit.test("USPostal", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enablePlanet", true, 0, ret_USPostal);
  test_BarCodeGetSymbology_initial_value("enablePostnet", true, 0, ret_USPostal);
...
function test_UKPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("UKPostal", "enable", [0,1]);
  test_BarCodeSetSymbology_valid_value("UKPostal", "transmitCheckDigit", [0,1]);
} 

function test_UKPostal_Invalid(){
  test_BarCodeSetSymbology_invalid_value("UKPostal", "enable", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("UKPostal", "transmitCheckDigit", [-1,2]);
}

QUnit.test("UKPostal", function(assert) {
  var ret_UKPostal = test_BarCodeGetSymbology_return_object("UKPostal", false);

  //test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_UKPostal);
...
function test_JapanPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("JapanPostal", "enable", [1,0]);
} 

function test_JapanPostal_Invalid(){
  test_BarCodeSetSymbology_invalid_value("JapanPostal", "enable", [-1,2]);
}

QUnit.test("JapanPostal", function(assert) {
  var ret_JapanPostal = test_BarCodeGetSymbology_return_object("JapanPostal", true);
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_JapanPostal);
...
function test_AustralianPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("AustralianPostal", "enable", [1,0]);
} 

function test_AustralianPostal_Invalid(){
  test_BarCodeSetSymbology_invalid_value("AustralianPostal", "enable", [-1,2]);
} 
...
QUnit.test("AustralianPostal", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_AustralianPostal);
...
function test_DutchPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("DutchPostal", "enable", [1,0]);
}

function test_DutchPostal_Invalid(){
  test_BarCodeSetSymbology_invalid_value("DutchPostal", "enable", [-1,2]);
} 

QUnit.test("DutchPostal", function(assert) {
  var ret_DutchPostal = test_BarCodeGetSymbology_return_object("DutchPostal", true);
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_DutchPostal);
...
function test_USPSPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("USPSPostal", "enable", [0,1]);
} 

function test_USPSPostal_Invalid(){
  test_BarCodeSetSymbology_invalid_value("USPSPostal", "enable", [-1,2]);
} 

QUnit.test("USPSPostal", function(assert) {
  var ret_USPSPostal = test_BarCodeGetSymbology_return_object("USPSPostal", false);
  //test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_USPSPostal);
...
function test_UPUFICSPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("UPUFICSPostal", "enable", [0,1]);
} 

function test_UPUFICSPostal_Invalid(){
  test_BarCodeSetSymbology_invalid_value("UPUFICSPostal", "enable", [-1,2]);
} 

QUnit.test("UPUFICSPostal", function(assert) {
  var ret_UPUFICSPostal = test_BarCodeGetSymbology_return_object("UPUFICSPostal", false);
  //test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_UPUFICSPostal);
...
function test_Ean13_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("Ean13", "convertToISSN", [1,0]);
  test_BarCodeSetSymbology_valid_value("Ean13", "booklandISBNFormat", -1);
...
function test_Ean13_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("Ean13", "convertToISSN", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("Ean13", "booklandISBNFormat", [-2,0,2]);
...
QUnit.test("Ean13", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("convertToISSN", true, 0, ret_Ean13);
  test_BarCodeGetSymbology_initial_value("booklandISBNFormat", false, -1, ret_Ean13);
...
function test_UpcA_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("UpcA", "transmitSystemNumber", [0,2]);
...
function test_UpcA_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("UpcA", "transmitSystemNumber", [-2,1,3]);
...
QUnit.test("UpcA", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("transmitSystemNumber", true, 2, ret_UpcA);
...
function test_UpcE_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("UpcE", "transmitSystemNumber", [0,2]);
...
function test_UpcE_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("UpcE", "transmitSystemNumber", [-2,1,3]);
...
QUnit.test("UpcE", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("transmitSystemNumber", true, 2, ret_UpcE);
...
function test_UpcE1_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("UpcE1", "addon2", [1,2]);
  test_BarCodeSetSymbology_valid_value("UpcE1", "addon5", [1,2]);
  test_BarCodeSetSymbology_valid_value("UpcE1", "transmitCheckDigit", -1);
  test_BarCodeSetSymbology_valid_value("UpcE1", "transmitSystemNumber", -1);
  test_BarCodeSetSymbology_valid_value("UpcE1", "convertToUpcA", -1);
} 
...
function test_UpcE1_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("UpcE1", "transmitCheckDigit", [-2,0,2]);
  test_BarCodeSetSymbology_invalid_value("UpcE1", "transmitSystemNumber", [-2,0,2]);
  test_BarCodeSetSymbology_invalid_value("UpcE1", "convertToUpcA", [-2,0,2]);
} 
...
QUnit.test("UpcE1", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("addon2", true, 2, ret_UpcE1);
  test_BarCodeGetSymbology_initial_value("addon5", true, 2, ret_UpcE1);
  test_BarCodeGetSymbology_initial_value("transmitCheckDigit", false, -1, ret_UpcE1);
  test_BarCodeGetSymbology_initial_value("transmitSystemNumber", false, -1, ret_UpcE1);
  test_BarCodeGetSymbology_initial_value("convertToUpcA", false, -1, ret_UpcE1);
...
function test_Aztec_Valid(){
  test_BarCodeSetSymbology_valid_value("Aztec", "enable", [1,0]);
}

function test_Aztec_Invalid(){
  test_BarCodeSetSymbology_invalid_value("Aztec", "enable", [-1,2]);
} 

QUnit.test("Aztec", function(assert) {
  var ret_Aztec = test_BarCodeGetSymbology_return_object("Aztec", true);
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Aztec);
...
function test_DataMatrix_Valid(){
  test_BarCodeSetSymbology_valid_value("DataMatrix", "enable", [0,1]);
  test_BarCodeSetSymbology_valid_value("DataMatrix", "fieldSeparator", [127,0]);
  test_BarCodeSetSymbology_valid_value("DataMatrix", "mirrorImage", [2,0]);
}

function test_DataMatrix_Invalid(){
  test_BarCodeSetSymbology_invalid_value("DataMatrix", "enable", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("DataMatrix", "fieldSeparator", -2);
  test_BarCodeSetSymbology_invalid_value("DataMatrix", "mirrorImage", [-2,1,3]);
}

QUnit.test("DataMatrix", function(assert) {
  var ret_DataMatrix = test_BarCodeGetSymbology_return_object("DataMatrix", true);

  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_DataMatrix);
...
function test_MaxiCode_Valid(){
  test_BarCodeSetSymbology_valid_value("MaxiCode", "enable", [1,0]);
} 

function test_MaxiCode_Invalid(){
  test_BarCodeSetSymbology_invalid_value("MaxiCode", "enable", [-1,2]);
} 

QUnit.test("MaxiCode", function(assert) {
  var ret_MaxiCode = test_BarCodeGetSymbology_return_object("MaxiCode", true);
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_MaxiCode);
...
function test_MicroPDF417_Valid(){
  test_BarCodeSetSymbology_valid_value("MicroPDF417", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("MicroPDF417", "code128Emulation", [1,0]);
}

function test_MicroPDF417_Invalid(){
  test_BarCodeSetSymbology_invalid_value("MicroPDF417", "enable", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("MicroPDF417", "code128Emulation", [-1,2]);
}

QUnit.test("MicroPDF417", function(assert) {
  var ret_MicroPDF417 = test_BarCodeGetSymbology_return_object("MicroPDF417", true);

  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_MicroPDF417);
...
function test_MicroQR_Valid(){
  test_BarCodeSetSymbology_valid_value("MicroQR", "enable", [0,1]);
} 

function test_MicroQR_Invalid(){
  test_BarCodeSetSymbology_invalid_value("MicroQR", "enable", [-1,2]);
} 

QUnit.test("MicroQR", function(assert) {
  var ret_MicroQR = test_BarCodeGetSymbology_return_object("MicroQR", false);
  //test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_MicroQR);
...
function test_PDF417_Valid(){
  test_BarCodeSetSymbology_valid_value("PDF417", "enable", [0,1]);
...
function test_PDF417_Invalid(){
  test_BarCodeSetSymbology_invalid_value("PDF417", "enable", [-1,2]);
...
QUnit.test("PDF417", function(assert) {
  var ret_PDF417 = test_BarCodeGetSymbology_return_object("PDF417", true);

  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_PDF417);
...
function test_QRCode_Valid(){
  test_BarCodeSetSymbology_valid_value("QRCode", "enable", [1,0]);
} 

function test_QRCode_Invalid(){
  test_BarCodeSetSymbology_invalid_value("QRCode", "enable", [-1,2]);
}

QUnit.test("QRCode", function(assert) {
  var ret_QRCode = test_BarCodeGetSymbology_return_object("QRCode", true);
  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_QRCode);
...
function test_Plessey_Valid(){
  test_BarCodeSetSymbology_valid_value("Plessey", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("Plessey", "unconventionalStop", [1,0]);
  test_BarCodeSetSymbology_valid_value("Plessey", "transmitCheckDigit", [1,0]);
  test_BarCodeSetSymbology_valid_value("Plessey", "length1", [0,55]);
  test_BarCodeSetSymbology_valid_value("Plessey", "length2", [0,55]);
} 

function test_Plessey_Invalid(){
  test_BarCodeSetSymbology_invalid_value("Plessey", "enable", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("Plessey", "unconventionalStop", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("Plessey", "transmitCheckDigit", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("Plessey", "length1", [-2,56,256]);
  test_BarCodeSetSymbology_invalid_value("Plessey", "length2", [-2,56,256]);
} 

QUnit.test("Plessey", function(assert) {
  var ret_Plessey = test_BarCodeGetSymbology_return_object("Plessey", true);

  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Plessey);
  ...
  test_BarCodeGetSymbology_initial_value("length1", true, 0, ret_Plessey);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Plessey);

  //==Valid==
  test_Plessey_Valid();
  //==Invalid==
  test_Plessey_Invalid();
});


//--Telepen----------------------------------------------------
function test_Telepen_Valid(){
  test_BarCodeSetSymbology_valid_value("Telepen", "enable", [1,0]);
  test_BarCodeSetSymbology_valid_value("Telepen", "format", [1,0]);
  test_BarCodeSetSymbology_valid_value("Telepen", "length1", [0,55]);
  test_BarCodeSetSymbology_valid_value("Telepen", "length2", [0,55]);
} 

function test_Telepen_Invalid(){
  test_BarCodeSetSymbology_invalid_value("Telepen", "enable", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("Telepen", "format", [-2,2]);
  test_BarCodeSetSymbology_invalid_value("Telepen", "length1", [-2,56,256]);
  test_BarCodeSetSymbology_invalid_value("Telepen", "length2", [-2,56,256]);
}

QUnit.test("Telepen", function(assert) {
  var ret_Telepen = test_BarCodeGetSymbology_return_object("Telepen", true);

  test_BarCodeGetSymbology_initial_value("enable", true, 0, ret_Telepen);
  test_BarCodeGetSymbology_initial_value("format", true, 0, ret_Telepen);
  test_BarCodeGetSymbology_initial_value("length1", true, 0, ret_Telepen);
  test_BarCodeGetSymbology_initial_value("length2", true, 0, ret_Telepen);
...
//--UserPreferences----------------------------------------------------
function test_BarCodeSetUserPreferences_Valid(){
  test_BarCodeSetUserPreferences_valid_value("addonSecurityLevel", -1);
  test_BarCodeSetUserPreferences_valid_value("displayMode", -1);
  test_BarCodeSetUserPreferences_valid_value("laserOnTime", -1);    
  test_BarCodeSetUserPreferences_valid_value("negativeBarcodes", -1);
  test_BarCodeSetUserPreferences_valid_value("pickListMode", -1);
  test_BarCodeSetUserPreferences_valid_value("redundancyLevel", -1);
  test_BarCodeSetUserPreferences_valid_value("scanAngle", -1);
  test_BarCodeSetUserPreferences_valid_value("securityLevel", -1);
  test_BarCodeSetUserPreferences_valid_value("timeoutBetweenSameSymbology", [0,2550]);
  test_BarCodeSetUserPreferences_valid_value("transmitCodeIdChar", [1,0]);;
  test_BarCodeSetUserPreferences_valid_value("triggerMode", [3,0]);
  test_BarCodeSetUserPreferences_valid_value("decodingIllumniation", [0,1]);
  ...
  test_BarCodeSetUserPreferences_valid_value("timeoutPresentationMode", [60000,1800000,900000]);
  test_BarCodeSetUserPreferences_valid_value("decodingIlluminationPowerLevel", -1);
  test_BarCodeSetUserPreferences_valid_value("aimerMode", [1,2,0]);
  test_BarCodeSetUserPreferences_valid_value("centerDecoding", [1,0]);
  test_BarCodeSetUserPreferences_valid_value("centerDecodingTolerance", [100,0]);
}

function test_BarCodeSetUserPreferences_Invalid(){
  test_BarCodeSetUserPreferences_invalid_value("addonSecurityLevel", [-2,2,30]);
  test_BarCodeSetUserPreferences_invalid_value("displayMode", [-2,0,2]);
  test_BarCodeSetUserPreferences_invalid_value("laserOnTime", [-2,2,6000]);    
  ...
  test_BarCodeSetUserPreferences_invalid_value("redundancyLevel", [-2,1,2]);
  ...
  test_BarCodeSetUserPreferences_invalid_value("timeoutBetweenSameSymbology", [-2,-1,2551]);
  test_BarCodeSetUserPreferences_invalid_value("transmitCodeIdChar", [-2,-1,2]);
  test_BarCodeSetUserPreferences_invalid_value("triggerMode", [-2,-1,1,4]);
  test_BarCodeSetUserPreferences_invalid_value("decodingIllumniation", [-1,2]);
  test_BarCodeSetUserPreferences_invalid_value("decodingAimingPattern", [-2,0,2]);
  test_BarCodeSetUserPreferences_invalid_value("interCharGapSize", [-2,2,6,10]);
  test_BarCodeSetUserPreferences_invalid_value("timeoutPresentationMode", [59999,1800001]);
  test_BarCodeSetUserPreferences_invalid_value("decodingIlluminationPowerLevel", [-2,0,2,11]);
  test_BarCodeSetUserPreferences_invalid_value("aimerMode", [-1,3]);
  test_BarCodeSetUserPreferences_invalid_value("centerDecoding", [-1,2]);
  test_BarCodeSetUserPreferences_invalid_value("centerDecodingTolerance", [-1,101]);
}
...
QUnit.test("BarCodeGetUserPreferences", function( assert ){
  ...
  test_BarCodeGetUserPreferences_initial_value("addonSecurityLevel", false, -1, ret);
  test_BarCodeGetUserPreferences_initial_value("displayMode", false, -1, ret);
  test_BarCodeGetUserPreferences_initial_value("laserOnTime", false, -1, ret);
  ...
  test_BarCodeGetUserPreferences_initial_value("redundancyLevel", false, -1, ret);
  ...
  test_BarCodeGetUserPreferences_initial_value("timeoutBetweenSameSymbology", true, 300, ret);
  ...
  test_BarCodeGetUserPreferences_initial_value("decodingIllumniation", true, 1, ret);
  ...
  test_BarCodeGetUserPreferences_initial_value("timeoutPresentationMode", true, 900000, ret);
  test_BarCodeGetUserPreferences_initial_value("decodingIlluminationPowerLevel", false, -1, ret);
  test_BarCodeGetUserPreferences_initial_value("aimerMode", true, 0, ret);
  test_BarCodeGetUserPreferences_initial_value("centerDecoding", true, 0, ret);
  test_BarCodeGetUserPreferences_initial_value("centerDecodingTolerance", true, 0, ret);      

  //==Valid==
  test_BarCodeSetUserPreferences_Valid();
  //==Invalid==
  test_BarCodeSetUserPreferences_Invalid();
});
