...
QUnit.test("BarCodeGetReaderType", function(assert) 
{
    ...
    assert.ok(name=="4500", "Return value passed["+name+"]");
});
...
function test_BarCodeGetDecodersStatus_Valid()
{
    test_BarCodeSetDecodersStatus_valid_value("enableAustralianPostal", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableAztec", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableCompositeCC_AB", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableCompositeCC_C", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableCompositeTlc39", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableCode11", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableCode39", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableCode93", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableCode128", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableCodabar", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableChinese2Of5", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableDataMatrix", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableDutchPostal", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableEanJan8", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableEanJan13", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableGs1128", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableGs1DataBar14", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableGs1DataBarLimited", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableGs1DataBarExpanded", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableGs1DatabarToUpcEan", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableIsbt128", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableIndustrial2Of5", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableInterleaved2Of5", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableJapanPostal", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableKorean3Of5", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableMatrix2Of5", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableMaxiCode", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableMicroPDF417", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableMicroQR", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableMsi", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enablePDF417", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enablePlessey", -1);
    test_BarCodeSetDecodersStatus_valid_value("enableQRcode", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableTelepen", -1);
    test_BarCodeSetDecodersStatus_valid_value("enableTriopticCode39", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableUpcA", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableUpcE", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableUpcE1", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableUccCoupon", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableUKPostal", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableUPUFICSPostal", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableUSPostnet", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableUSPlanet", [1,0]);
    test_BarCodeSetDecodersStatus_valid_value("enableUSPSPostal", [1,0]);
}
...
function test_BarCodeSetDecodersStatus_Invalid()
{
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableCompositeTlc39", [-1,2]);
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableChinese2Of5", [-1,2]);
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableGs1DatabarToUpcEan", [-1,2]);
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableKorean3Of5", [-1,2]);
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enablePlessey", [-2,0]);
  test_BarCodeSetDecodersStatus_invalid_value("enableQRcode", [-1,2]);
  test_BarCodeSetDecodersStatus_invalid_value("enableTelepen", [-2,0]);
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableUccCoupon", [-1,2]);
  test_BarCodeSetDecodersStatus_invalid_value("enableUKPostal", [-1,2]);
  test_BarCodeSetDecodersStatus_invalid_value("enableUPUFICSPostal", [-1,2]);
  ...
  test_BarCodeSetDecodersStatus_invalid_value("enableUSPSPostal", [-1,2]);
}
...
QUnit.test("BarCodeGetDecodersStatus", function(assert) 
{
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableCompositeCC_AB", true, 0, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableCompositeCC_C", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableCompositeTlc39", true, 0, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableCode11", true, 1, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableChinese2Of5", true, 1, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableGs1DatabarToUpcEan", true, 0, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableKorean3Of5", true, 0, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableMicroPDF417", true, 0, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableMicroQR", true, 1, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableTriopticCode39", true, 0, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableUccCoupon", true, 0, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableUKPostal", true, 1, ret_BarCodeGetDecodersStatus);
  test_BarCodeGetDecodersStatus_initial_value("enableUPUFICSPostal", true, 1, ret_BarCodeGetDecodersStatus);
  ...
  test_BarCodeGetDecodersStatus_initial_value("enableUSPSPostal", true, 1, ret_BarCodeGetDecodersStatus);

  //==Valid==
  test_BarCodeGetDecodersStatus_Valid();
  //==Invalid==
...
function test_Codabar_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("Codabar", "enable", [0,1]);
...
function test_Code11_Valid(){
  test_BarCodeSetSymbology_valid_value("Code11", "enable", [0,1]);
...
QUnit.test("Code11", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_Code11);
...
function test_GS1128_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("GS1128", "fieldSeparator", [128,0]);
...
function test_ISBT128_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("ISBT128", "concatenation", [0,1,2]);
  test_BarCodeSetSymbology_valid_value("ISBT128", "concatenationRedundancy", [2,20,10]);
} 
...
QUnit.test("ISBT128", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("concatenation", true, 2, ret_ISBT128);
  test_BarCodeGetSymbology_initial_value("concatenationRedundancy", true, 10, ret_ISBT128);
...
function test_Chinese2Of5_Valid(){
  test_BarCodeSetSymbology_valid_value("Chinese2Of5", "enable", [0,1]);
}

function test_Chinese2Of5_Invalid(){
  test_BarCodeSetSymbology_invalid_value("Chinese2Of5", "enable", [-1,2]);
}

QUnit.test("Chinese2Of5", function(assert) {
  var ret_Chinese2Of5 = test_BarCodeGetSymbology_return_object("Chinese2Of5", true);
  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_Chinese2Of5);
...
function test_Interleaved2Of5_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("Interleaved2Of5", "convertToEan13", [1,0]);
}
...
function test_Interleaved2Of5_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("Interleaved2Of5", "convertToEan13", [-1,2]);
}
...
QUnit.test("Interleaved2Of5", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("convertToEan13", true, 0, ret_Interleaved2Of5);
...
function test_Composite_Valid(){
  test_BarCodeSetSymbology_valid_value("Composite", "enableCc_C", [0,1]);
  test_BarCodeSetSymbology_valid_value("Composite", "enableCc_AB", [1,0]);
  test_BarCodeSetSymbology_valid_value("Composite", "enableTlc39", [1,0]);
  test_BarCodeSetSymbology_valid_value("Composite", "enableUpcMode", [0,2,1]);
  test_BarCodeSetSymbology_valid_value("Composite", "enableEmulationMode", [1,0]);
}
...
function test_Composite_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("Composite", "enableTlc39", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("Composite", "enableUpcMode", [-2,3]);
  test_BarCodeSetSymbology_invalid_value("Composite", "enableEmulationMode", [-1,2]);
}

QUnit.test("Composite", function(assert) {
  var ret_Composite = test_BarCodeGetSymbology_return_object("Composite", true);

  test_BarCodeGetSymbology_initial_value("enableCc_C", true, 1, ret_Composite);
  test_BarCodeGetSymbology_initial_value("enableCc_AB", true, 0, ret_Composite);
  test_BarCodeGetSymbology_initial_value("enableTlc39", true, 0, ret_Composite);
  test_BarCodeGetSymbology_initial_value("enableUpcMode", true, 1, ret_Composite);
  test_BarCodeGetSymbology_initial_value("enableEmulationMode", true, 0, ret_Composite);
...
function test_UccCoupon_Valid(){
  test_BarCodeSetSymbology_valid_value("UccCoupon", "enable", [1,0]);
}
...
function test_GS1DataBar14_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("GS1DataBar14", "convertToUpcEan", [1,0]);
  test_BarCodeSetSymbology_valid_value("GS1DataBar14", "securityLevel", [0,2,3,1]);
}

function test_GS1DataBar14_Invalid(){
  test_BarCodeSetSymbology_invalid_value("GS1DataBar14", "enable", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("GS1DataBar14", "convertToUpcEan", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("GS1DataBar14", "securityLevel", [-2,4]);
}
...
QUnit.test("GS1DataBar14", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("convertToUpcEan", true, 0, ret_GS1DataBar14);
  test_BarCodeGetSymbology_initial_value("securityLevel", true, 1, ret_GS1DataBar14);
...
function test_GS1DataBarLimited_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("GS1DataBarLimited", "convertToUpcEan", [0,1]);
  test_BarCodeSetSymbology_valid_value("GS1DataBarLimited", "securityLevel", [1,2,4,3]);
}

function test_GS1DataBarLimited_Invalid(){
  test_BarCodeSetSymbology_invalid_value("GS1DataBarLimited", "enable", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("GS1DataBarLimited", "convertToUpcEan", [-1,2]);
  test_BarCodeSetSymbology_invalid_value("GS1DataBarLimited", "securityLevel", [0,5]);
}
...
QUnit.test("GS1DataBarLimited", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("convertToUpcEan", true, 0, ret_GS1DataBarLimited);
  test_BarCodeGetSymbology_initial_value("securityLevel", true, 3, ret_GS1DataBarLimited);
...
function test_GS1DataBarExpanded_Valid(){
  ...
  test_BarCodeSetSymbology_valid_value("GS1DataBarExpanded", "fieldSeparator", [128,0]);
  test_BarCodeSetSymbology_valid_value("GS1DataBarExpanded", "securityLevel", [0,2,3,1]);
} 
...
function test_GS1DataBarExpanded_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("GS1DataBarExpanded", "securityLevel", [-2,4]);
}
...
QUnit.test("GS1DataBarExpanded", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("securityLevel", true, 1, ret_GS1DataBarExpanded);
...
function test_Korean3Of5_Valid(){
  test_BarCodeSetSymbology_valid_value("Korean3Of5", "enable", [1,0]);
} 
...
function test_Msi_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("Msi", "length1", [-2,56]);
  test_BarCodeSetSymbology_invalid_value("Msi", "length2", [-2,56]);
...
function test_USPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("USPostal", "enablePlanet", [0,1]);
  test_BarCodeSetSymbology_valid_value("USPostal", "enablePostnet", [0,1]);
...
QUnit.test("USPostal", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enablePlanet", true, 1, ret_USPostal);
  test_BarCodeGetSymbology_initial_value("enablePostnet", true, 1, ret_USPostal);
...
function test_JapanPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("JapanPostal", "enable", [0,1]);
} 
...
QUnit.test("JapanPostal", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_JapanPostal);
...
function test_AustralianPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("AustralianPostal", "enable", [0,1]);
}
...
QUnit.test("AustralianPostal", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_AustralianPostal);
...
function test_DutchPostal_Valid(){
  test_BarCodeSetSymbology_valid_value("DutchPostal", "enable", [0,1]);
}
...
QUnit.test("DutchPostal", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_DutchPostal);
...
function test_Ean13_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("Ean13", "booklandISBNFormat", [-2,2]);
...
function test_UpcA_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("UpcA", "transmitSystemNumber", [-2,3]);
...
function test_UpcE_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("UpcE", "transmitSystemNumber", [-2,3]);
...
function test_UpcE1_Invalid(){
  ...
  test_BarCodeSetSymbology_invalid_value("UpcE1", "transmitSystemNumber", [-2,3]);
...
function test_Aztec_Valid(){
  test_BarCodeSetSymbology_valid_value("Aztec", "enable", [0,1]);
} 
...
QUnit.test("Aztec", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_Aztec);
...
function test_MaxiCode_Valid(){
  test_BarCodeSetSymbology_valid_value("MaxiCode", "enable", [0,1]);
} 
...
QUnit.test("MaxiCode", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_MaxiCode);
...
QUnit.test("MicroQR", function(assert) {
  var ret_MicroQR = test_BarCodeGetSymbology_return_object("MicroQR", true);
...
function test_QRCode_Valid(){
  test_BarCodeSetSymbology_valid_value("QRCode", "enable", [0,1]);
}
...
QUnit.test("QRCode", function(assert) {
  ...
  test_BarCodeGetSymbology_initial_value("enable", true, 1, ret_QRCode);
...
function test_BarCodeGetUserPreferences_Invalid(){
  ...
  test_BarCodeSetUserPreferences_valid_value("displayMode", [1,0]);
  test_BarCodeSetUserPreferences_valid_value("laserOnTime", 6000);    
  test_BarCodeSetUserPreferences_valid_value("negativeBarcodes", [0,1,3]);
  test_BarCodeSetUserPreferences_valid_value("pickListMode", [0,1]);
  test_BarCodeSetUserPreferences_valid_value("redundancyLevel", [1,2,3,4]);
  test_BarCodeSetUserPreferences_valid_value("scanAngle", -1);
  test_BarCodeSetUserPreferences_valid_value("securityLevel", [0,1,2,3]);
  test_BarCodeSetUserPreferences_valid_value("timeoutBetweenSameSymbology", [0,9900]);
  test_BarCodeSetUserPreferences_valid_value("transmitCodeIdChar", [0,1]);
  ...
  test_BarCodeSetUserPreferences_valid_value("decodingAimingPattern", [0,1]);
  test_BarCodeSetUserPreferences_valid_value("interCharGapSize", [6,10]);
  test_BarCodeSetUserPreferences_valid_value("timeoutPresentationMode", [60000,1800000]);
  test_BarCodeSetUserPreferences_valid_value("decodingIlluminationPowerLevel", [0, 10]);
...
function test_BarCodeGetUserPreferences_Invalid(){
  ...
  test_BarCodeSetUserPreferences_invalid_value("displayMode", [-1,2]);
  test_BarCodeSetUserPreferences_invalid_value("laserOnTime", -1);    
  test_BarCodeSetUserPreferences_invalid_value("negativeBarcodes", [-1,3]);
  test_BarCodeSetUserPreferences_invalid_value("pickListMode", [-1,2]);
  ...
  test_BarCodeSetUserPreferences_invalid_value("securityLevel", [-1,4]);
  ...
  test_BarCodeSetUserPreferences_invalid_value("triggerMode", [-1,1,4]);
  test_BarCodeSetUserPreferences_invalid_value("decodingillumniation", [-1,2]);
  test_BarCodeSetUserPreferences_invalid_value("decodingAimingPattern", [-1,2]);
  test_BarCodeSetUserPreferences_invalid_value("interCharGapSize", [5,8,11]);
  test_BarCodeSetUserPreferences_invalid_value("timeoutPresentationMode", [59999,1800001]);
  test_BarCodeSetUserPreferences_invalid_value("decodingIlluminationPowerLevel", [-1,11]);
  test_BarCodeSetUserPreferences_invalid_value("aimerMode", [-2,0]);
  test_BarCodeSetUserPreferences_invalid_value("centerDecoding", [-2,0]);
  test_BarCodeSetUserPreferences_invalid_value("centerDecodingTolerance", [-2,0]);
}
...
QUnit.test("BarCodeGetUserPreferences", function( assert ){
    ...
    test_BarCodeGetUserPreferences_initial_value("displayMode", true, 0, ret);
    test_BarCodeGetUserPreferences_initial_value("laserOnTime", true, 3000, ret);
    test_BarCodeGetUserPreferences_initial_value("negativeBarcodes", true, 0, ret);
    test_BarCodeGetUserPreferences_initial_value("pickListMode", true, 0, ret);
    ...
    test_BarCodeGetUserPreferences_initial_value("securityLevel", true, 0, ret);
    ...
    test_BarCodeGetUserPreferences_initial_value("decodingAimingPattern", true, 1, ret);
    test_BarCodeGetUserPreferences_initial_value("interCharGapSize", true, 6, ret);
    test_BarCodeGetUserPreferences_initial_value("timeoutPresentationMode", true, 900000, ret);
    test_BarCodeGetUserPreferences_initial_value("decodingIlluminationPowerLevel", true, 10, ret);
...
//=============================================================================
// QUnit.module("SCANNER API");
// QUnit.test("BarCodeRelease", function(assert) {
//   js_sleep(300);
//   js.BarCodeRelease();
//   assert.ok(true, "Reader release success");
// });
